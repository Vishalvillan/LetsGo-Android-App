...
public class work extends AppCompatActivity {
    ...
    TextView textView,pmuscles;
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_work);
        getSupportActionBar().hide();
        imageView=findViewById(R.id.workimage);
        ...
        if(a.equals("Normal Pushups")){
            ...
            imageView.setImageResource(R.drawable.diamond1);
            ...
            imageView.setImageResource(R.drawable.bench1);
            ...
            imageView.setImageResource(R.drawable.dips1);
            ...
            imageView.setImageResource(R.drawable.squat1);
            ...
            imageView.setImageResource(R.drawable.flut1);
            wi2.setImageResource(R.drawable.flut2);
            textView.setText("This is normal");
        }
        else if(a.equals("Lunges")){
            imageView.setImageResource(R.drawable.lunges1);
            ...
            imageView.setImageResource(R.drawable.regular1);
            ...
            imageView.setImageResource(R.drawable.widebar1);
            ...
            imageView.setImageResource(R.drawable.rows1);
            ...
            imageView.setImageResource(R.drawable.bentover1);
            ...
            imageView.setImageResource(R.drawable.exten1);
            ...
            imageView.setImageResource(R.drawable.overhead1);
            ...
            imageView.setImageResource(R.drawable.conc1);
            ...
            imageView.setImageResource(R.drawable.curl1);
            ...
            imageView.setImageResource(R.drawable.barb1);
            wi2.setImageResource(R.drawable.barb2);
            textView.setText("This is normal");
     }
        else if(a.equals("Hammer Curl")){
            imageView.setImageResource(R.drawable.hammer1);
            ...
            imageView.setImageResource(R.drawable.plank1);
            wi2.setImageResource(R.drawable.plank1);
            textView.setText("This is normal");
        }
        else if(a.equals("Bicycle Crunches")){
            imageView.setImageResource(R.drawable.cycle1);
            ...
            imageView.setImageResource(R.drawable.raise1);
            ...
            imageView.setImageResource(R.drawable.rev1);
